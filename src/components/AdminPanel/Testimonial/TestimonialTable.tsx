...
export const columns: ColumnDef<ITestimonial>[] = [
    {
        accessorKey: "testimonial_name_english",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => <div className="lowercase">{row.getValue("testimonial_name_english")}</div>,
    },
    {
        accessorKey: "testimonial_name_bangla",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => <div className="lowercase">{row.getValue("testimonial_name_bangla")}</div>,
    },
    {
        accessorKey: "testimonial_occupation_english",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => <div className="lowercase">{row.getValue("testimonial_occupation_english")}</div>,
    },
    {
        accessorKey: "testimonial_occupation_bangla",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => <div className="lowercase">{row.getValue("testimonial_occupation_bangla")}</div>,
    },
    {
        accessorKey: "testimonial_comment_english",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
        ...
        cell: ({ row }) => <div className="lowercase">{row.getValue("testimonial_comment_english")}</div>,
    },
    {
        accessorKey: "testimonial_comment_bangla",
        header: ({ column }) => {
            return (
                <Button
                    variant="ghost"
    ...
    },
    {
        ...
        enableHiding: false,
        cell: ({ row }) => {
            const testimonialInfo = row.original
            console.log(row);
...
export function TestimonialTable() {
    ...
    const table = useReactTable<ITestimonial>({
